...
MetaWrap.Logging =
{
    ...
    */
    Constructor:function(p_buttons)
    {
        ...
        if (this.g_on)
        {
			...
			//alert("MetaWrap.g_site_root = " + MetaWrap.g_site_root);
    ...
    */
    Reconstruct:function(p_buttons)
    {
			...
			l_div_node.innerHTML = this.CreateWidgetHTML() + "<link rel=\"stylesheet\" type=\"text/css\" href=\"" + MetaWrap.g_site_root + MetaWrap.g_js_root + "css/mw_lib_logger.css\" />";
    ...
    */
    Log:function(p_message,p_level,p_url,p_line)
    {
		...
		if (window.console)
		{
			console.log("[" + this.g_classes[p_level] + "] " + p_message);
		}
		
		// look for the onyx serial port
		if ((debug) && (debug.print))
		{
			debug.print("[" + this.g_classes[p_level] + "] " +  p_message);
		}
